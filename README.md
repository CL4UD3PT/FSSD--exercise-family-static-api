<!-- hide -->
# 👨‍👩‍👦 Family Static API by CL4UD3PT
<!-- endhide -->

The Jackson Family needs a static API! We need to build the *data structures* and create API endpoint to interact with it using Postman or Insomnia.
...
This API has 4 endpoints. They all return JSON:
...
Which deletes a family member with `id` given
